    ...
    <div className="min-h-screen bg-gray-100">
      <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          ...
          <p className="mt-2 text-lg text-gray-600">Welcome to your dashboard, {session.user.email}!</p>
            ...
            <dl className="mt-4 grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
              ...
              {session.user.user_metadata?.name && (
                <div className="sm:col-span-1">
                  ...
                  <dd className="mt-1 text-sm text-gray-900">{session.user.user_metadata.name}</dd>
                </div>
              )}
            </dl>
          </div>
